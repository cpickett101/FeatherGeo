    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-box" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="about-title">
        ...
        <div className="about-body">
          ...
          <p>
            Drop in a layer, inspect your features, run spatial operations and export the result, all without your data ever leaving the browser.
          </p>
        ...
        <div className="about-footer">
          ...
          <div></div>
          <div>
                        <a className="about-badge" href="https://viglino.github.io/font-gis" target="_blank" rel="noopener noreferrer">
              Icons from font-gis
            </a>
